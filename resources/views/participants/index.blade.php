...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('participants.create') }}" class="btn btn-primary">
        <i class="bi bi-person-plus me-1"></i> Nouveau participant
    </a>
</div>
    ...
    <div class="card-body py-2">
        <form method="GET" action="{{ route('participants.index') }}">
            <div class="input-group">
                ...
                @if(request('search'))
                    <a href="{{ route('participants.index') }}" class="btn btn-outline-secondary">✕</a>
                @endif
            </div>
        </form>
    </div>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('events.show', $participant->event_id) }}"
