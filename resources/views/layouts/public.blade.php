...
<nav class="navbar navbar-expand-lg sticky-top" style="background:#1a56db;padding:.75rem 0;">
    <div class="container">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            @auth
                <a href="{{ route('dashboard') }}" style="background:rgba(255,255,255,0.15);color:#fff;padding:.45rem 1.1rem;border-radius:8px;text-decoration:none;font-size:.9rem;font-weight:500;">
