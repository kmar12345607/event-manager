...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .navbar .container { height: 70px; display: flex; align-items: center; justify-content: space-between; }
        .navbar-brand {
        ...
        .nav-links a { color: #555; font-weight: 500; text-decoration: none; font-size: 0.9rem; transition: color 0.2s; }
        .nav-links a:hover { color: #1a237e; }
        .btn-login {
            border: 2px solid #1a237e; color: #1a237e; border-radius: 30px;
            padding: 9px 24px; font-weight: 700; font-size: 0.88rem;
            transition: all 0.3s; text-decoration: none;
        }
        .btn-login:hover { background: #1a237e; color: white; }
        .btn-start {
            background: linear-gradient(135deg, #1a237e, #1565c0);
            color: white; border-radius: 30px; padding: 9px 24px;
            font-weight: 700; font-size: 0.88rem;
            text-decoration: none; transition: all 0.3s;
            box-shadow: 0 4px 15px rgba(21,101,192,0.3);
        }
        .btn-start:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(21,101,192,0.4); color: white; }
...
<section class="section" style="background:white;">
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-6 col-md-3">
                <a href="#events" class="cat-card c1">
            ...
            <div class="col-6 col-md-3">
                <a href="#events" class="cat-card c2">
            ...
            <div class="col-6 col-md-3">
                <a href="#events" class="cat-card c3">
            ...
            <div class="col-6 col-md-3">
                <a href="#events" class="cat-card c4">
